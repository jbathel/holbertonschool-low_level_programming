...
/**
 * pqueue_create - dynamically allocate and initialize
 * a new queue node
...
/**
 * pqueue_insert_sorted - insert an item into a sorted
 * priority queue
 ...
 * Return: a pointer to the front of the queue
 */
pqueue_t *binary_tree_to_queue(const bt_t *tree, pqueue_t **front,
		size_t depth)
{
	pqueue_t *temp = NULL;
